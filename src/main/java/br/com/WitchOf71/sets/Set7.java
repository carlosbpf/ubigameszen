...
public class Set7 extends GameSet {
	...
	gameSetBackground.setSpriteImgPath("img/seu_madruga_set.png");
	...
	public void update(){
		...
		if(player.getPosition().x > 600){
			GameComponents.get(org.unbiquitous.uImpala.engine.core.Game.class).change(new Set8());
		}
	}
