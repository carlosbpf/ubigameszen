...
public class Set3 extends GameSet {
	...
	gameSetBackground.setSpriteImgPath("img/barbearia_do_seu_madruga_set.png");
	...
	public void update(){
		...
		if(player.getPosition().x > 600){
			GameComponents.get(org.unbiquitous.uImpala.engine.core.Game.class).change(new Set4());
		}
	}
