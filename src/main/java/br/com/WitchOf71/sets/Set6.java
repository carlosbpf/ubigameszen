...
public class Set6 extends GameSet {
	...
	gameSetBackground.setSpriteImgPath("img/sala_de_aula_set.png");
	...
	public void update(){
		...
		if(player.getPosition().x > 600){
			GameComponents.get(org.unbiquitous.uImpala.engine.core.Game.class).change(new Set7());
		}
	}
