...
public class Set8 extends GameSet {
	...
	gameSetBackground.setSpriteImgPath("img/terreno_baldio_set.png");
	gameSetBackground.init();
	
	this.enemy = new Bruxa(assets,false);
