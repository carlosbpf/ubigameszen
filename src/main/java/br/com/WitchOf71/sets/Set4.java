...
public class Set4 extends GameSet {
	...
	gameSetBackground.setSpriteImgPath("img/florinda_set.png");
	...
	public void update(){
		...
		if(player.getPosition().x > 600){
			GameComponents.get(org.unbiquitous.uImpala.engine.core.Game.class).change(new Set5());
		}
	}
