...
public class Set5 extends GameSet {
	...
	gameSetBackground.setSpriteImgPath("img/parque_de_diversoes_set.png");
	...
	public void update(){
		...
		if(player.getPosition().x > 600){
			GameComponents.get(org.unbiquitous.uImpala.engine.core.Game.class).change(new Set6());
		}
	}
